...
namespace TheLittleOnesLibrary.Entities
{
    public class EventEntity
    {
        ...
        // Create records
        public EventEntity(AccountEntity accountEntity, string eventTitle, string eventDesc, string eventType, DateTime eventDateTime, DateTime eventCreatedDate, string eventStatus)
        {
        ...
        public EventEntity(string eventID, AccountEntity accountEntity, string eventTitle, string eventDesc, string eventType, DateTime eventDateTime, DateTime eventCreatedDate, string eventStatus)
        {
