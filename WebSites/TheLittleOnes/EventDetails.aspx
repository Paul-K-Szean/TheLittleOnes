                            ...
                            <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="dataTables_length" id="dynamic-table_length">
                                            Display 
                                                <asp:DropDownList ID="DDLDisplayRecordCountEvent" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLDisplayRecordCountEvent_SelectedIndexChanged">
                                        ...
                                        <div id="dynamic-table_filter" class="dataTables_filter">
                                            <span class="block input-icon input-icon-right  toolbar">
                                                <asp:DropDownList ID="DropDownList2" runat="server" CssClass=" form-control">
                                                    <asp:ListItem Value="">Filter Type</asp:ListItem>
                                                    <asp:ListItem Value="">Cancelled</asp:ListItem>
                                                    <asp:ListItem Value="">Comfirmed</asp:ListItem>
                                                    <asp:ListItem Value="">Complete</asp:ListItem>
                                                </asp:DropDownList>
                                            </span>
                                            <label class="block clearfix">
                                                <span class="block input-icon input-icon-right">Search:         
                                                    <asp:TextBox ID="TBSearchEvent" runat="server" CssClass="form-control  input-sm" placeholder="EG: Vet"
                                ...
                                <asp:GridView ID="GVEvent" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="eventDateCreated" HeaderText="eventDateCreated" SortExpression="eventDateCreated" />
                                    </Columns>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-horizontal">
                            <asp:Panel ID="PNLEventEdit" runat="server" Visible="false">
                                <%--action buttons--%>
                                <div class="row">
                                    <div class="col-xs-12 ">
                                        <div class="form-inline pull-right">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <asp:DropDownList ID="DDLEventTime" runat="server" CssClass="form-control"
                                                                AutoPostBack="true" OnSelectedIndexChanged="DDLEventTime_SelectedIndexChanged"
                                                        ...
                                                        <div class="input-group center">
                                                            <asp:Label runat="server" ID="LBLEventStatus" Text=""></asp:Label>
                                                        </div>
                                                        <div class="input-group">
